...
import { AssetHandoverDialog } from "@/components/AssetHandoverDialog";
            ...
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  {" "}
                  across {assets.length} unique entries
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-slate-200 shadow-sm">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  {stats.totalItems > 0
                    ? ((stats.availableItems / stats.totalItems) * 100).toFixed(
                        0,
                      )
                    : 0}
                  % utilization rate
          ...
          <Table>
            <TableHeader className="bg-slate-50 border-b border-slate-100">
              <TableRow className="hover:bg-slate-50">
                <TableHead className="w-[300px] font-semibold text-slate-600">
                  Asset Details
                </TableHead>
                ...
                <TableRow>
                  <TableCell colSpan={5} className="h-64 text-center">
                    <div className="flex flex-col items-center justify-center space-y-2">
                      ...
                      <p className="text-xs text-slate-400">
                        Adjust search or add new inventory.
                      </p>
                    </div>
                  </TableCell>
                </TableRow>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          {asset.donor?.name && (
                            <div className="flex items-center gap-1.5">
                              <Badge
                                variant="secondary"
                                className="bg-slate-100 text-slate-600 hover:bg-slate-200 border-0 text-[10px] px-2"
                              >
                      ...
                      <TableCell className="text-right align-top">
                        <div className="flex justify-end items-center gap-2">
                          <AssetHandoverDialog
                            ...
                            availableQuantity={asset.VariableQuantity}
