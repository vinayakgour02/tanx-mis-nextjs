...
export function ViewReportDialog({ reportId }: ViewReportDialogProps) {
  ...
  const totalLeverage = report
    ? (Number(report.leverageGovt) || 0) +
      (Number(report.leverageCsr) || 0) +
      (Number(report.leverageCommunity) || 0)
    : 0;
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-sm font-medium">
                        {report.activity?.Intervention?.name}
                      </p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="text-sm font-medium">
                        {report.activity?.subInterventionRel?.name}
                      </p>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-center">
                      ...
                      <p className="text-sm font-semibold">
                        {format(new Date(report.reportingDate), "PPP")}
                      </p>
                    </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm font-medium">
                        {report.interventionArea?.villageName?.name || "N/A"},{" "}
                        {report.interventionArea?.blockName?.name || "N/A"}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        {report.interventionArea?.district?.name || "N/A"},{" "}
                        {report.interventionArea?.state?.name || "N/A"}
                      </p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {format(
                            new Date(report.trainingReport.dateFrom),
                            "PPP",
                          )}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {format(
                            new Date(report.trainingReport.dateTo),
                            "PPP",
                          )}
                        </p>
                      </div>
                    ...
                    {report.trainingReport.participants?.length > 0 ? (
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant="secondary" className="text-xs">
                            {report.trainingReport.participants.length}{" "}
                            Participant
                            {report.trainingReport.participants.length !== 1
                              ? "s"
                              : ""}
                          </Badge>
                        </div>
                        ...
                        <div className="space-y-3">
                          {report.trainingReport.participants.map(
                        ...
                        <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                            ...
                            <div>
                              ...
                              <span className="ml-1 font-semibold">
                                {
                                  report.trainingReport.participants.filter(
                                    (p: any) => p.gender === "Male",
                                  ).length
                                }
                              </span>
                      ...
                      <div className="text-center py-8 border-2 border-dashed border-gray-200 rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          No participants recorded for this training
                        </p>
                      </div>
                    )}
                  </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {report.infrastructureReport.infrastructureName}
                        </p>
                      </div>
                      <div>
                        <span className="text-sm text-muted-foreground">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {report.infrastructureReport.dprApproved
                            ? "Yes"
                            : "No"}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {report.infrastructureReport.approvedDesignFollowed
                            ? "Yes"
                            : "No"}
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {formatIndianCurrency(
                            Number(
                              report.infrastructureReport.sanctionBudget,
                            ) || 0,
                          )}
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {formatIndianCurrency(
                            Number(
                              report.infrastructureReport.expensesIncurred,
                            ) || 0,
                          )}
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {[
                        {
                          key: "preConstructionPhotos",
                          label: "Pre-Construction",
                        },
                        {
                          key: "duringConstructionPhotos",
                          label: "During Construction",
                        },
                        {
                          key: "postConstructionPhotos",
                          label: "Post-Construction",
                        },
                      ].map(({ key, label }) => {
                        const items = parsePhotos(
                          (report.infrastructureReport as any)[key],
                        );
                        return (
                          <div key={key}>
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">
                        {report.infrastructureReport.infrastructureUniqueId}
                      </p>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {report.householdReport.beneficiaryName}
                        </p>
                      </div>
                      <div>
                        <span className="text-sm text-muted-foreground">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {report.householdReport.socialGroup}
                        </p>
                      </div>
                      <div>
                        <span className="text-sm text-muted-foreground">
                        ...
                        <p className="text-sm font-medium">
                          {report.householdReport.maleMembers}
                        </p>
                      </div>
                      <div>
                        <span className="text-sm text-muted-foreground">
                        ...
                        <p className="text-sm font-medium">
                          {report.householdReport.femaleMembers}
                        </p>
                      </div>
                      <div>
                        <span className="text-sm text-muted-foreground">
                        ...
                        <p className="text-sm font-medium">
                          {report.householdReport.totalMembers}
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium">
                        {report.householdReport.uniqueId}
                      </p>
                    </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        Created by {report.creator.firstName}{" "}
                        {report.creator.lastName}
                      </span>
                    </div>
