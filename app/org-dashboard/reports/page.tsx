    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <div className="flex gap-2">
          {canCreate("reports") && <CreateReportDialog onReportCreated={handleReportCreated} />}
          <Link className="text-sm p-2.5 bg-black text-white rounded-md" href={'/org-dashboard/reports/raw'}>View Raw Data</Link>
        </div>
      </CardHeader>
      <CardContent>
